...
import { callUpdateBook, Getcategory, UploadIMGAPI } from '../../../services/axios.api';

const BookModalUpdate = (props) => {
    const { openModalUpdate, setOpenModalUpdate, dataDetail, setDataDetail, FetchBooks } = props;
    ...
    useEffect(() => {
        if (dataDetail?._id) {
            ...
            const arrSlider = dataDetail?.slider?.map(item => {
                return {
                    uid: uuidv4(),
                    name: item,
                    status: 'done',
